...
// ═══════════════════════════════════════════════════════════
router.post('/calls/:id/attachments', auth_1.authenticate, (req, res, next) => {
    ...
    try {
        ...
        const uploadResults = await (0, storageService_1.uploadFiles)(files);
...
router.delete('/attachments/:id', auth_1.authenticate, async (req, res) => {
    try {
        ...
        await (0, storageService_1.deleteFile)(attachment.fileUrl);
